...
-   reworked hit search to match query words as substrings, so partial and infix queries now match (e.g. "westernhagen" finds "Marius Müller-Westernhagen" and "bangar" finds "Bangaranga")
